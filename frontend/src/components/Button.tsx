...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const sizeClasses = {
            sm: iconOnly ? 'size-8 text-sm' : 'py-2 px-3 text-sm',
            md: iconOnly ? 'size-10 text-sm' : 'py-3 px-4 text-sm',
            lg: iconOnly ? 'size-12 text-base' : 'py-3 px-4 text-base',
        };
        ...
        const variantColorClasses: Record<ButtonVariant, Record<ButtonColor, string>> = {
            ...
            outline: {
                ...
                danger: 'border-2 border-red-600 text-red-600 hover:bg-red-600 hover:text-white focus:ring-red-500 active:bg-red-700 active:text-white',
                warning:
            ...
            ghost: {
                ...
                danger: 'text-red-600 hover:bg-red-100 hover:text-red-700 focus:ring-red-500 active:bg-red-200',
                warning:
            ...
            soft: {
                ...
                danger: 'bg-red-100 text-red-800 hover:bg-red-200 focus:ring-red-500 active:bg-red-300',
                warning:
            ...
            white: {
                ...
                danger: 'bg-white border border-gray-200 text-gray-800 hover:bg-gray-50 focus:ring-red-500 active:bg-gray-100',
                warning:
            ...
            link: {
                ...
                danger: 'text-red-600 hover:text-red-700 underline-offset-4 hover:underline focus:ring-red-500 active:text-red-800',
                warning:
